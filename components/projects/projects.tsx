...
const PROJECTS: Project[] = [
  {
    id:"AFTer",
    icon: Sparkles,
    iconLabel: "After Design Studio",
    title:
        "A local design studio and creative Agency focused on elevating the visual identity of local businesses. ",

  description:
      "I co-founded After Design Studio, an independant industrial designing agency where curious ideas meets powertools and able.",
    meta: "Chief Technical Officer, 2024",
    imageRatio: 752 / 497,
    image:
  ...
  },
  {
    id: "break",
    icon: Wand2,
    iconLabel: "Breakmind Studio",
    title: "A two week brand and product sprint for an AI image manipulation tool.",
    description:
      "Breakmind is a powerful, client-side web application that uses Artificial Intelligence to remove image backgrounds instantly. It operates entirely within the browser using TensorFlow.js",
